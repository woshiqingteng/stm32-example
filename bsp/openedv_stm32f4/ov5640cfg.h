/**
 * @file    ov5640cfg.h
 * @brief   OV5640 register tables (vendor values, ASCII comments).
 *
 * Included only by ov5640.c. The tables are static so they do not leak symbols.
 */

#ifndef BSP_OV5640CFG_H
#define BSP_OV5640CFG_H

#include <stdint.h>

/* JPEG output, 7.5 fps, up to 2592x1944. */
static const uint16_t ov5640_jpeg_reg_tbl[][2] =
{
    ...
    { 0x4407, 0x01 },   /* quantization scale */
    { 0x460b, 0x35 },
    { 0x460c, 0x22 },
    { 0x4837, 0x16 },   /* MIPI global timing */
    { 0x3824, 0x02 },   /* PCLK manual divider */
    { 0x5001, 0xA3 },   /* SDE, scaling, CMX, AWB on */
    { 0x3503, 0x00 }    /* AEC/AGC on */
};

/* RGB565 output, 15 fps, up to 1280x800. */
static const uint16_t ov5640_rgb565_reg_tbl[][2] =
{
    ...
    { 0x5001, 0xA3 },   /* SDE, scale, UV average off, CMX, AWB on */
    { 0x3503, 0x00 }    /* AEC/AGC on */
};

/* Default UXGA initialisation, 24 MHz input clock. */
static const uint16_t ov5640_init_reg_tbl[][2] =
{
    ...
    { 0x3108, 0x01 },   /* PCLK / SCLK2x / SCLK root dividers */
    { 0x3630, 0x36 },
    { 0x3631, 0x0e },
    { 0x3632, 0xe2 },
    { 0x3633, 0x12 },
    ...
    { 0x3634, 0x40 },
    { 0x3622, 0x01 },
    { 0x3c01, 0x34 },   /* 50/60Hz band auto, bit[7] */
    ...
    { 0x501f, 0x00 },   /* YUV 422 */
    { 0x440e, 0x00 },
    { 0x5000, 0xa7 },   /* Lenc, raw gamma, BPC, WPC, CIP on */
    { 0x3a0f, 0x30 },   /* AEC stable range in high */
    { 0x3a10, 0x28 },   /* AEC stable range in low */
    { 0x3a1b, 0x30 },   /* AEC stable range out high */
    { 0x3a1e, 0x26 },   /* AEC stable range out low */
    { 0x3a11, 0x60 },   /* AEC fast zone high */
    { 0x3a1f, 0x14 },   /* AEC fast zone low */
    ...
    { 0x4740, 0X21 }    /* VSYNC active low */
};

#endif /* BSP_OV5640CFG_H */
